...
<body>
  ...
  <main>
    <section class="view active" id="jobs-view">
      ...
      <div class="container section"><div class="section-head"><div><h2>Recommended jobs <span class="result-count" id="resultCount">6 matches</span></h2><p>Ranked using your QA and automation profile.</p></div><button class="btn ghost" id="clearBtn">Clear filters</button></div><div class="jobs-grid" id="jobsGrid"></div></div>
    </section>
